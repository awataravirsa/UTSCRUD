...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
        <div class="p-6">
            <a href="index.html" class="text-white text-3xl font-semibold uppercase hover:text-gray-300">BOOKING
                BICYCLE</a>
            <button
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="{{route('berita.index')}}" class="flex items-center text-white py-4 pl-6 nav-item">
                <i class="fas fa-tablet-alt mr-3">Daftar Pelanggan</i>
                Daftar Pelanggan
            </a>
        </nav>
        <a href="#"
